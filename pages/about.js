      ...
      <section id="about" className="w-[50%] mt-[3rem] lg:w-[70%] md:w-[90%]">
        <div className="">
         ...
         <p>anywash is a setup headquater in lagos, Nigeria. We aim to achieve the provision of free access to quick, structured and regulated laundry 
          in real time. This helps the average population in getting their clothes bags, shoes etc as clean as they want it. At anywash, we want everyone to find it easy to get cothes washed and cleaned up and it's additional services are delivered as quick as possible. Over time,People will 
