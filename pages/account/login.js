        ...
        <section className='h-[80vh] w-full flex flex-col items-center justify-center '>
           <div className='w-[30%]  bg-white shadow-md rounded-md border-2 dark:bg-gray-700 p-4'>
            <div className='w-full h-full flex flex-col gap-2 items-center'>
               ...
               <button type="button" className='h-[3rem] rounded-md border-2 w-fit p-2 flex items-center gap-2'>
                <img src="../icons/googleLogo.png" alt="google" className='h-[2.5rem] w-[2.5rem] ' />
               ...
               <form onSubmit={``} className="w-full flex flex-col items-center gap-2">
                  ...
                  <div className="relative">
                      <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                       ...
                       <input type="text" id="email" className="bg-gray-50 border focus:outline-light-blue border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@email.com" />
                       </div>
